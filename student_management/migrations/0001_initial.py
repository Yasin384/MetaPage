# Generated by Django 5.0.9 on 2024-09-21 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.IntegerField(blank=True, choices=[(1, '1'), (2, '2'), (3, '3')], null=True)),
                ('faculty', models.CharField(blank=True, choices=[('КБ', 'КБ'), ('БЧ', 'БЧ'), ('ИЯ', 'ИЯ'), ('КвПС', 'КвПС'), ('ИИ', 'ИИ'), ('РИ', 'РИ')], max_length=10, null=True)),
